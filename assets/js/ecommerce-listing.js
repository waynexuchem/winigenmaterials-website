(function () {
  ...
  function renderOnlineCard(card, product, variants, detailHref, subpage) {
    ...
    const modeLabel = product.commercialStatus === 'PRICE_SHIPPING_REVIEW'
  ...
  function render() {
    ...
    document.querySelectorAll('.product-card').forEach(card => {
      ...
      if (['ONLINE_CHECKOUT', 'PRICE_SHIPPING_REVIEW'].includes(product.commercialStatus) && activeVariants.length > 0) {
